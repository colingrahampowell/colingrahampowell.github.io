...
Unfortunately, I had a difficult time finding the start of the "Stacker" function called in `L2Exercise2()`; the WinDBG disassembler was difficult to use. Using a tip from a fellow class member on the Piazza page, I searched around memory address `5443232e`, and found the following:
