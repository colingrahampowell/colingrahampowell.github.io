...
<mark class="disagree">At every layer of the protocols, there is a general rule whose application can lead to enormous benefits in robustness and interoperability:</mark>
...
Thus concluded our whirlwind tour of network security. Next, we travel to the top of the network stack, discussing web security.
